...
const Success = () => {
  ...
  return (
    <div className="container_success">
      {/* <Helmet>
        <title>Payment Successful | ICLSMHA 2026</title>
        <meta
          name="description"
          content="Payment successful. Thank you for registering for ICLSMHA 2026. Your registration details are confirmed."
        />
        <meta name="robots" content="noindex, follow" />
        <link rel="canonical" href="https://iclsmha.cerada.in/success" />
      </Helmet> */}
