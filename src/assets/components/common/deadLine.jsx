      ...
      <div className="bg-white  p-6 max-w-md w-full mx-auto mt-2">
        ...
        <div className="flex gap-4">
          <a
            ...
            className="flex-1 text-center !text-white py-2 rounded-lg bg-indigo-600 hover:opacity-90 transition"
          >
            Submit Paper
          </a>
          ...
          <a
            ...
            className="flex-1 text-center !text-indigo-600 py-2 rounded-lg bg-amber-400 hover:opacity-90 transition"
          >
            Register Now
          </a>
        </div>
