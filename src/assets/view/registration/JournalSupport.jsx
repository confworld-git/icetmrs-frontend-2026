...
import { journalPackages } from "../../../utils/jouralData";
    ...
    <div className="py-8 px-4 md:px-6">
          ...
          return (
            <div
              ...
              className={`
                ...
                ${
                  isSelected
                    ? "border-indigo-800 shadow-lg shadow-indigo-800/20 bg-indigo-800"
                    : "border-gray-200 bg-indigo-50 hover:border-indigo-600 hover:shadow-md"
                }
              `}
            >
              {/* Badge */}
              ...
              {/* Tier name */}
              <h3
                className={`font-bold text-base mb-0.5 pr-8 ${
      ...
      <div className="flex pt-4">
        <button
          ...
          className="py-2 px-4 rounded-xl border border-indigo-700 text-xs font-medium transition-colors flex items-center justify-center gap-1.5 ml-auto hover:bg-indigo-50"
        >
          <span className="text-indigo-700">👁 View Package Inclusions</span>
        </button>
      </div>

      {/* Selected summary bar */}
      {selectedJournal && (
        <div className="mt-5 flex items-center justify-between bg-indigo-800 rounded-xl px-5 py-3 shadow-md shadow-indigo-200">
