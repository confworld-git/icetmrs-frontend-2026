...
const CorporateCards = () => {
  ...
  return (
    <section>
      <Hero
        title="Exhibits & Sponsors"
        breadcrumbs={[{ label: "Home", link: "#" }]}
        backgroundImage="/images/commonhero/15.webp"
      />
          ...
          <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 pt-20 px-4">
            <div className="bg-white rounded-xl shadow-lg max-w-3xl w-full p-6 relative">
              ...
              <h2 className="text-2xl font-bold text-teal-600 mb-4 text-center">
                Sponsor Registration — {formData.sponsorshipType} (
                {formData.sponsorshipPrice})
              </h2>
              ...
              >
                ...
                <input
                  ...
                  value={formData.sponsorshipPrice}
                  readOnly
                  className="hidden"
                />
                ...
                <div className="md:col-span-2 flex justify-end gap-4 mt-2">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-3 rounded bg-teal-600 hover:bg-teal-700 text-white font-bold"
                  >
