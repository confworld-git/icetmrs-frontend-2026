...
const ROLE_COLORS = {
  "Welcome Address": "text-indigo-600",
  "Guest of Honour": "text-indigo-600",
  "Conference Chair": "text-indigo-600",
  "Keynote Speakers": "text-indigo-500",
  "Session Speakers": "text-indigo-500",
  "Session Chairs": "text-indigo-500",
};

const BADGE_COLORS = {
  "Welcome Address": "bg-indigo-50 text-indigo-700 border border-indigo-200",
  "Guest of Honour": "bg-indigo-50 text-indigo-700 border border-indigo-200",
  "Conference Chair": "bg-indigo-50 text-indigo-700 border border-indigo-200",
  "Keynote Speakers": "bg-indigo-50 text-indigo-700 border border-indigo-200",
              ...
              ({ image, name, title, title2, title3, title4, title5, title6, country, back }, index) => (
                ...
                >
                  ...
                  <img
                    ...
                    height={200}
                    loading="lazy"
                    className="w-[200px] h-[200px] rounded-full object-cover border-4 border-indigo-400 p-1 mb-3"
                  />

                  {/* Speaker Name */}
                  <h2 className="text-base font-semibold text-center mb-2 min-h-[40px] flex items-center text-indigo-700">
                    {name}
                  </h2>
